...
const questions = ["team", "match", "speaker", "amp", "speaker2", "apm2", "speed", "ranking", "hang"];
...
function whereOnChain(element) {
    if (element.includes("left")) { whereonchainstring = "Left"; } else if (element.includes("right")) { whereonchainstring = "Right"; } else { whereonchainstring = "Didn't"; }
}
